...
app.get(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      const saveVideoPromise = new Promise<void>((resolve, reject) => {
        videoStream
      ...
      const saveAudioPromise = new Promise<void>((resolve, reject) => {
        audioStream
      ...
      await Promise.all([saveVideoPromise, saveAudioPromise]);
